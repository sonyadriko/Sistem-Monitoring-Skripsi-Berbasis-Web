            ...
            <div class="card-body">
                ...
                <form class="forms-sample">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="viewKodeUnik" value="{{ Auth::user()->kode_unik }}" disabled>
                    </div>
                    <div class="mb-3">
                        <label for="viewName" class="form-label">Nama</label>
                        <input type="text" class="form-control" id="viewName" value="{{ Auth::user()->name }}" disabled>
                    </div>
                    <div class="mb-3">
                        <label for="viewAlamatMahasiswa" class="form-label">Alamat Mahasiswa</label>
                        <input type="text" class="form-control" id="viewAlamatMahasiswa" value="{{ $details->alamat_mhs }}" disabled>
                    </div>
                    <div class="mb-3">
                        <label for="viewNoTelpMahasiswa" class="form-label">No Telp Mahasiswa</label>
                        <input type="text" class="form-control" id="viewNoTelpMahasiswa" value="{{ $details->no_telp_mhs }}" disabled>
                    </div>
                    <div class="mb-3">
                        <label for="viewAlamatOrangTua" class="form-label">Alamat Orang Tua</label>
                        <input type="text" class="form-control" id="viewAlamatOrangTua" value="{{ $details->alamat_orang_tua }}" disabled>
                    </div>
                    <div class="mb-3">
                        <label for="viewNoTelpOrangTua" class="form-label">No Telp Orang Tua</label>
                        <input type="text" class="form-control" id="viewNoTelpOrangTua" value="{{ $details->no_telp_orang_tua }}" disabled>
                    </div>
                </form>
