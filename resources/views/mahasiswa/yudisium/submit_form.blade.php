                ...
                <div id="wizard">
                    ...
                    <section>
                        <form action="{{route('yudisium-store')}}" method="POST" enctype="multipart/form-data" id="yourFormId">
                            ...
                            <div class="mb-3">
                                <label for="serti_file" class="form-label">Upload File Sertifikat TEFL</label>
                                <input class="form-control" type="file" name="serti_file" id="serti_file" />
...
<script>
    ...
    // Check if both files are uploaded
            var proposalFile = $('#serti_file').val();
