...
<div class="container-xxl flex-grow-1 container-p-y">
    {{-- @if(is_null($revisisp) || is_null($revisisp->detail_berita_acara_p)) --}}
            ...
            <div class="card mb-4 mb-xl-0">
                ...
                <div class="card-body">
                    <form action="javascript:void(0)" method="POST" enctype="multipart/form-data">
                        ...
                        {{-- <input type="hidden" id="bimbingan_proposal_id" name="bimbingan_proposal_id" value="{{ $revisisp->id_berita_acara_p }}" /> --}}
