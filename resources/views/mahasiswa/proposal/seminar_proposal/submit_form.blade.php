                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <p class="card-text text-center">File Proposal yang sudah di acc, slip asli
                                                pembayaran bimbingan skripsi.</p>
                                        </div>
                                    </div>
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <p class="card-text text-center">Melakukan pengisian form pendaftaran seminar.
                                            </p>
                                        </div>
                                    </div>
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <p class="card-text text-center">Menunggu jadwal seminar dari koordinator
                                                skripsi</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <form action="{{ route('seminar-proposal.submit') }}" method="POST"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="dospem1"
                                        value="{{ $datas->dosen_pembimbing_utama }}" placeholder="Dosen Pembimbing 1"
                                        aria-describedby="defaultFormControlHelp" readonly />
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <label for="slip_file" class="form-label">Upload File Slip Pembayaran Sidang
                                        Proposal</label>
