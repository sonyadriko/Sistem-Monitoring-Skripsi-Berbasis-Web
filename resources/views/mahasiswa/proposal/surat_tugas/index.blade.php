                                        ...
                                        <div class="card-group">
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-text text-center">Melakukan pengisian form pengajuan
                                                        surat tugas.</p>
                                                </div>
                                            </div>
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-text text-center">Melakukan pengambilan surat tugas di
                                                        CSR Jurusan.</p>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <section>
                                    <form action="{{ route('pengajuan-st.store') }}" method="POST"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" type="text" id="judulskripsi"
                                                value="{{ $datas->judul }}" name="judulskripsi"
                                                placeholder="Masukan Dosen Pembimbing 1..." readonly />
                                            @error('judulskripsi')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" type="text" id="dospem1" name="dospem1"
                                                value="{{ $datas->dosen_pembimbing_utama }}" readonly
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" type="text" id="dospem2" name="dospem2"
                                                value="{{ $datas->dosen_pembimbing_ii }}" readonly
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" type="text" id="name" name="nama"
                                                value="{{ Auth::user()->name }}" readonly autocomplete="nama" />
                                            @error('nama')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" type="text" id="npm"
                                                value="{{ Auth::user()->kode_unik }}" name="npm" readonly />
                                            @error('npm')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="mb-3">
                                            <label for="tanggal_sidang_proposal" class="form-label">Tanggal Sidang Proposal
                                                Skripsi</label>
                                            <input class="form-control" type="date" name="tanggal_sidang_proposal"
                                                id="tanggal_sidang_proposal" />
                                            @error('tanggal_sidang_proposal')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="mb-3">
                                            <label for="file_proposal" class="form-label">Upload File Proposal
                                                Skripsi</label>
                                        ...
                                        <div class="mb-3">
                                            <label for="file_slip_pembayaran" class="form-label">Upload File Slip
                                                Pembayaran Surat Tugas</label>
