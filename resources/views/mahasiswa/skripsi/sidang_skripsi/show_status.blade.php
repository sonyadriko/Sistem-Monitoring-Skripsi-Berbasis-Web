    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            @elseif ($datas->status == 'terima')
                <div class="card mb-3">
                    <div class="card-body">
                        <h4 class="card-title mb-3" style="font-weight: bold;">Pendaftaran Sidang Skripsi telah disubmit.
                        </h4>
                        <h6 class="mb-3">Pendaftaran yang anda lakukan akan dicek terlebih dahulu oleh koordinator, lalu
                            akan dibuatkan jadwal.</h4>
                            <h6 class="mb-3">Status Pendaftaran :
                ...
                <div class="card mb-3">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Persiapan Sidang Skripsi.</h4>
                    </div>
                    <div class="card-body table-responsive">
                        <div>
                            <p style="font-weight: bold">Lampiran :</p>
                            <ol>
                                <li>Slip ASLI Pembayaran Sidang Skripsi.</li>
                                <li>Slip ASLI Pembayaran Bimbingan & Perpanjangan Bimbingan (Jika perpanjangan/lebih dari 6
                                    bulan).
                                </li>
                                <li>Fotocopy Slip Pembayaran SPP bulan terakhir.</li>
                                <li>Slip ASLI Pembayaran Sidang Skripsi.</li>
                                <li>Slip ASLI Pembayaran Publikasi/HKI.</li>
                                <li>Legalisir/ Fotocopy ijazah SMA/SMK/MAN.</li>
                            </ol>
                        </div>
                        <div>
                            <p style="color: #FF1600; font-weight: bold">Note :</p>
                            <ul>
                                <li style="font-weight: bold">Semua persyaratan yang telah dikumpulkan ke jurusan setelah
                                    mengisi form pendaftaran sidang skripsi.
                                </li>
                                <li style="font-weight: bold">Gandakan laporan skripsi sebanyak 4x, dibawa pada saat hari
                                    sidang.
                                </li>
