                ...
                <div class="card-body table-responsive">
                    ...
                    <table id="datatable" class="table table-bordered dt-responsive nowrap w-100">
                        ...
                        <tbody>
                            ...
                            @foreach ($jadwalMengujip as $index => $jadwal)
                                <tr>
                                    <td>{{ $index + 1 }}</td>
                                    <td>{{ $jadwal->name }}</td>
                                    ...
                                    <td><a href="{{ url('/dosen/berita_acara_proposal/detail/' . $jadwal->id_berita_acara_p) }}"
                                            class="btn btn-primary">Detail</a></td>
                                </tr>
                            @endforeach
                            @foreach ($jadwalMengujis as $index => $jadwal)
                                <tr>
                                    <td>{{ $index + 1 }}</td>
                                    <td>{{ $jadwal->name }}</td>
                                    <td>{{ $jadwal->kode_unik }}</td>
                                    ...
                                    <td><a href="{{ url('/dosen/berita_acara_skripsi/detail/' . $jadwal->id_berita_acara_s) }}"
                                            class="btn btn-primary">Detail</a></td>
                                </tr>
                            @endforeach
                        </tbody>
