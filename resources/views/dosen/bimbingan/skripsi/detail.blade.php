...
<div class="row">
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card mb-4">
            <h5 class="card-header">Detail Bimbingan Skripsi</h5>
            <div class="card-body">
                <p >
                    ...
                    <input class="form-control input-like-span" type="text" id="dospem1" name="dospem1" value="{{ $data->dosen_pembimbing_utama }}" readonly autocomplete="off"/><br/>
                    <span class="span0-1">Dosen Pembimbing II :</span>
                    {{-- <span class="span1-1">{{ $data->dosen_pembimbing_ii }}<br /></span> --}}
                    <input class="form-control input-like-span" type="text" id="dospem2" name="dospem2" value="{{ $data->dosen_pembimbing_ii }}" readonly autocomplete="off"/><br/>
                </p>
            </div>
        </div>
        <div class="row">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-primary"
                                            onclick="prepareModal({{ $item->id_detail_bimbingan_skripsi }})">
                                            Tambahkan Revisi
                                        </button>
