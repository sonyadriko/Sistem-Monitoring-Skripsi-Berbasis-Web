    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                ...
                <p class="card-title-desc">Jadwal Sidang Skripsi sebagai dosen penguji dapat dilihat pada tabel dibawah ini.</p>
            </div>
            <div class="card-body table-responsive">
                ...
                <!-- Tabel yang menampilkan data berita acara sidang skripsi -->
