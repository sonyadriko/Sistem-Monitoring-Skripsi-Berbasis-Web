                    ...
                    <table class="table table-bordered" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $detail->id_detail_bimbingan_proposal }}</td>
                                <td>{{ $detail->created_at }}</td>
                                <td>{{ $detail->revisi }}</td>
                                <td>


                                    <a href="{{ asset($detail->file) }}" class="btn btn-primary" target="_blank">cek file</a>
                                </td>
                                <td>{{ $detail->validasi }}</td>
                                <td>
                                    <button type="button" class="btn btn-primary" onclick="prepareModal({{ $detail->id_detail_bimbingan_proposal }})">
                                        Buka Modal
                                    </button>
...
<script>
    document.getElementById('revisiForm').addEventListener('submit', function(event) {
        ...
        // Kirim data revisi ke server menggunakan AJAX
