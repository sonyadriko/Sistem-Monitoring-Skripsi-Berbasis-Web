                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="mb-3">
                            ...
                            @if ($bidetail)
                                <textarea class="form-control" id="exampleFormControlTextarea1" name="keterangan" rows="3" placeholder="Masukan keterangan singkat mengenai tema/judul penelitian" readonly>{{$bidetail->keterangan}}</textarea>
                            @else
                                <p>No data found.</p>
                            @endif
                        </div>
