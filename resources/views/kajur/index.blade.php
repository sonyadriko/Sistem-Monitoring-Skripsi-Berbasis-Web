      ...
      <div class="card mb-4">
        <div class="card-body p-3">
          <div class="d-flex justify-content-between flex-row flex-sm-column gap-3">
            <div class="d-flex flex-sm-column flex-row align-items-start justify-content-between">
              <div class="card-title">
                <h5 class="text-nowrap mb-2">Jadwal Seminar & Sidang</h5>
              </div>
              <iconify-icon icon="solar:book-linear">{{$total}}</iconify-icon>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="card-body p-3">
          <div class="d-flex justify-content-between flex-row flex-sm-column gap-3">
            <div class="d-flex flex-sm-column flex-row align-items-start justify-content-between">
              ...
              <iconify-icon icon="solar:book-linear">{{$bidangIlmuCount}}</iconify-icon>
            </div>
          </div>
        </div>
      </div>
