        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="card-title-desc">Data registrasi user dapat dilihat pada tabel di bawah ini.</p>
                </div>
                        ...
                        <tbody>
                            @foreach ($datas as $index => $data)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('terima-pengguna', ['id' => $data->id]) }}" method="post"
                                            style="display: inline;">
                                            @csrf
                                            <button type="submit" class="btn btn-success">Terima</button>
                                        </form>
                                        <form action="{{ route('tolak-pengguna', ['id' => $data->id]) }}" method="post"
                                            style="display: inline;">
                                            @csrf
