        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="card-title-desc">List berita acara sidang skripsi dapat dilihat pada tabel dibawah ini, dan
                        ...
                        <tbody>
                            @foreach ($baskripsi as $index => $ba)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('/koordinator/berita_acara_skripsi/detail/' . $ba->id_berita_acara_s) }}"
