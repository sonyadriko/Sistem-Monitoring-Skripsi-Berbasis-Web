        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="card-title-desc">List pengajuan judul dapat dilihat pada tabel dibawah ini, dan juga terdapat
                        tombol detailnya.</p>
                </div>
                        ...
                        <tbody>
                            @foreach ($juduls as $index => $judul)
                                <tr>
                                    ...
                                    <td>{{ Str::words($judul->judul, 6, '...') }}</td>
                                    <td>{{ $judul->topik_bidang_ilmu }}</td>
                                    <td class="text-capitalize">{{ $judul->status }}</td>
                                    <td>
                                        <a href="{{ route('pengajuan-judul.detail', $judul->id_pengajuan_judul) }}"
