                ...
                <div class="card-body">
                    @if ($data->status === 'pending')
                        <form action="{{ route('update_status', ['id' => $data->id_pengajuan_judul]) }}" method="POST"
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" id="npm" value="{{ $data->kode_unik }}"
                                    name="npm" readonly disabled />
                            </div>
                            <div class="mb-3">
                                <label for="judul" class="form-label">Rencana Judul Proposal Skripsi</label>
                                <input class="form-control" type="text" id="judul" value="{{ $data->judul }}"
                                    name="judul" readonly disabled />
                            </div>
                            <div class="mb-3">
                                <label for="tbi" class="form-label">Topik Bidang Ilmu</label>
                                <input class="form-control" type="text" id="tbi"
                                    value="{{ $data->topik_bidang_ilmu }}" name="tbi" readonly disabled />
                            </div>
                            <div class="mb-3">
                                <label for="mk_pilihan" class="form-label">Mata Kuliah Pilihan Semester VIII dan VII</label>
                                <input class="form-control" type="text" id="mk_pilihan" value="{{ $data->mk_pilihan }}"
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="select2" name="dosen_pembimbing_ii">
                                    <option value="" selected disabled>Open this select menu</option>
                        ...
                        @if ($data->status == 'tolak')
                        @else
                            <form action="{{ route('pengajuan-judul-tolak', ['id' => $data->id_pengajuan_judul]) }}"
                                method="POST">
                                @csrf
                                <!-- ... form fields ... -->
                    ...
                    @else
                        ...
                        <div class="mb-3">
                            <label for="npm" class="form-label">NPM Mahasiswa</label>
                            <input class="form-control" type="text" id="npm" value="{{ $data->kode_unik }}"
                                name="npm" placeholder="13.2019.1.00819" readonly disabled />
                        </div>
                        <div class="mb-3">
                            <label for="judul" class="form-label">Rencana Judul Proposal Skripsi</label>
                            <input class="form-control" type="text" id="judul" value="{{ $data->judul }}"
                                name="judul" placeholder="13.2019.1.00819" readonly disabled />
                        </div>
                        <div class="mb-3">
                            <label for="tbi" class="form-label">Topik Bidang Ilmu</label>
                            <input class="form-control" type="text" id="tbi"
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="text" id="tbi"
                                value="{{ $data2->dosen_pembimbing_utama ?? 'Pengajuan ditolak' }}" name="tbi"
                                readonly disabled />
                        </div>
                        <div class="mb-3">
                            ...
                            <input class="form-control" style="text-transform: capitalize;" type="text"
                                id="tbi" value="{{ $data2->dosen_pembimbing_ii ?? 'Pengajuan ditolak' }}"
                                name="tbi" readonly disabled />
                        </div>
                        <input type="hidden" name="pengajuan_id" value="{{ $data->id_pengajuan_judul }}" />
                        <input type="hidden" name="bidang_ilmu_id" value="{{ $data->bidang_ilmu_id }}" />
