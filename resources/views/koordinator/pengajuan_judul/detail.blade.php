        ...
        <div class="card-body">
            ...
            <form action="{{ route('update_status', ['id_tema' => $data->id_tema]) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" type="text" id="id" name="id" value="{{ $data->id_tema }}" readonly />
                </div>
                ...
                <!-- Input Dosen Pembimbing II -->
                <div class="mb-3">
                    <label for="dosen_pembimbing_ii" class="form-label">Dosen II</label>
