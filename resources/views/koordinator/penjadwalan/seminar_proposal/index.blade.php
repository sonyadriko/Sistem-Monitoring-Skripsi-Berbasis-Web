        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="card-title-desc">List pengajuan sidang proposal dapat dilihat pada tabel dibawah ini, dan juga
                        terdapat tombol detailnya.
                    </p>
                </div>
                        ...
                        <tbody>
                            @foreach ($sempros as $index => $semp)
                                <tr>
                                    ...
                                    <td>{{ $semp->status }}</td>
                                    <td><a href="{{ url('/koordinator/jadwal_seminar_proposal/detail/' . $semp->id_seminar_proposal) }}"
