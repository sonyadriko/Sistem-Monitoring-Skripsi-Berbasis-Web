                ...
                <form action="{{ route('jadwal-sidang-skripsi-update', ['id' => $data->id_sidang_skripsi]) }}" method="POST" id="submitForm">
                  @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('sekretaris') is-invalid @enderror" id="select4" name="sekretaris" aria-label="Default select example">
            ...
            <div class="card-body">
                ...
                @csrf
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                            <label for="sekretaris" class="form-label" style="font-weight: bold">Sekretaris</label>
