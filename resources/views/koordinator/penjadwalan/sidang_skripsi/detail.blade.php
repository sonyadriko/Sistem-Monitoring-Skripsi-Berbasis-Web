...
<div class="row">
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card mb-4">
            ...
            @if (is_null($data)||is_null($data->nama_penguji_1)||is_null($data->nama_penguji_2))
            <div class="card-body">
          ...
          <div class="card-body">
            <form action="{{ route('cetak-berita-acara-s', ['id' => $data->id_sidang_skripsi]) }}" method="POST" id="cetakForm">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="dosenPenguji1" name="dosenPenguji1" value="{{$data->nama_penguji_1}}" readonly />
              </div>
              <div class="mb-3">
                <label for="dosenPenguji2" class="form-label">Dosen Penguji 2</label>
                <input type="text" class="form-control" id="dosenPenguji2" name="dosenPenguji2" value="{{$data->nama_penguji_2}}" readonly />
              </div>
              <div class="mb-3">
                <label for="dosenPenguji3" class="form-label">Dosen Penguji 3</label>
                <input type="text" class="form-control" id="dosenPenguji3" name="dosenPenguji3" value="{{$data->nama_penguji_3}}" readonly />
              </div>
              <div class="mb-3">
