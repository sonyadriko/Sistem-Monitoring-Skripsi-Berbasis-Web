...
@section('title', 'Tambah Mata Kuliah Pendukung')
...
@section('css')
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css"
        integrity="sha384-GLhlTQ8iN17EtM8Ckdo3hxJY98p+KBg0qD/I9z2QFmW6qq5CIK5BA/1EL86W39SK" crossorigin="anonymous">
@endsection
@section('content')
                        ...
                        <div class="row">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nama_mata_kuliah" name="nama_mata_kuliah"
                                    placeholder="Masukan Mata Kuliah..." aria-describedby="defaultFormControlHelp" />
                            </div>
                        ...
                        <div class="row">
                            <div class="d-flex justify-content-between mt-4">
                                ...
                                <button type="submit" class="btn btn-primary"
                                    onclick="$('#submitBtn').click();">Submit</button>
                            </div>
                        </div>
                    </form>
                </div>
